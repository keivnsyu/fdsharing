									...
									<li>
										...
										<ul>
											...
											<li>
												<a href="#"><?php echo $_SESSION['MM']?>，您好</a>
												<ul>
													<li><a href="admin/admin_member_management.php">會員管理系統</a></li>
													<li><a href="admin/admin_news_edit.php">最新消息</a></li>
													<li><a href="admin/admin_profile_edit.php">活動快訊</a></li>
													<li><a href="admin/admin_foodstores_edit.php">商家管理</a></li>
													<li><a href="admin/admin_management.php">管理總攬</a></li>
												</ul>
											</li>
											<li ><a href="logout.php">會員登出</a></li>';
								</ul>
